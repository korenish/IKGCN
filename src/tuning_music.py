...
print(f"Evaluating {dataset} model with {aggregator} as aggregators:")
...
for dim in dims:
    ...
    parser.add_argument('--neighbor_sample_size', type=int, default=music_properties['K'],
                        help='the number of neighbors to be sampled')
    parser.add_argument('--dim', type=int, default=dim,
                        help='dimension of user and entity embeddings')
    parser.add_argument('--n_iter', type=int, default=music_properties['H'],
                        help='number of iterations when computing entity representation')
    parser.add_argument('--batch_size', type=int, default=music_properties['batch_size'], help='batch size')
    parser.add_argument('--l2_weight', type=float, default=music_properties['l2_weight'],
                        help='weight of l2 regularization')
    parser.add_argument('--lr', type=float, default=music_properties['lr'], help='learning rate')
